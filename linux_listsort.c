 ...
 */
__attribute__((nonnull(2, 3, 4))) struct list_head *linux_merge(
    void *priv,
    list_cmp_func_t cmp,
    struct list_head *a,
    struct list_head *b)
 ...
 * throughout.
 */
__attribute__((nonnull(2, 3, 4, 5))) void merge_final(void *priv,
                                                      list_cmp_func_t cmp,
                                              ...
                                              list_cmp_func_t cmp)
{
    ...
    for (;;) {
        ...
        if (!next)
            break;
        list = linux_merge(priv, cmp, pending, list);
        pending = next;
    }
